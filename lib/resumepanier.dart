...
class _ResumePanierState extends State<ResumePanier> {
  ...
  void confirmerCommande() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Commande passée avec succès !",style: TextStyle(color: Color(0xFFF68B73)),)));


      // Videz le panier ici
      Provider.of<Panier>(context, listen: false).viderPanier();

      // Affiche le nombre de produits après la vidange du panier
      //
      //Navigator.popUntil(context, ModalRoute.withName('svg')); // Remplacez '/' par le nom de la route de votre page d'accueil
          ...
          children: <Widget>[
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: Color(0xFFF68B73), // Changer la couleur du texte
