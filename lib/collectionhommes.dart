...
import 'details.dart';
class Collectionhommes extends StatefulWidget {
  const Collectionhommes({Key? key}) : super(key: key);

  @override
  State<Collectionhommes> createState() => _CollectionhommesState();
}

class _CollectionhommesState extends State<Collectionhommes> {
  @override
